        ...
        static void Main(string[] args)
        {
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                using (BinaryWriter bw = new BinaryWriter(ms))
                {
                    ...
                    bw.Write(PSRC);
                    BinaryReader br = new BinaryReader(File.OpenRead(args[0] + ".hlsl"));
                    ...
                    br.Close();
                    bw.Write(PEXE);
                    br = new BinaryReader(File.OpenRead(args[0] + ".hlsl.comp"));
                ...
                BinaryWriter filebw = new BinaryWriter(File.Open(args[0] + ".psh", FileMode.Create));
